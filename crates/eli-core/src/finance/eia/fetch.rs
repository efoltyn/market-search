...
impl EiaPreset {
    pub fn from_str(s: &str) -> Option<Self> {
        match s.trim().to_ascii_lowercase().as_str() {
            ...
            "nat_gas" | "natgas" | "natural_gas" | "ng_storage" | "storage" => {
                Some(Self::NatGasStorage)
            }
        ...
        match self {
            ...
            Self::Energy => vec![
                ...
                EiaQuerySpec {
                    ...
                    facets: vec![("series", "EER_EPD2F_PF4_Y35NY_DPG")],
                    frequency: "daily",
                    data_col: "value",
